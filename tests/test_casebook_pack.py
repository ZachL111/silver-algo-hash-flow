"""Regression checks for the silver-algo-hash-flow casebook."""
...
from casebook.harness import assert_expected, silver_algo_hash_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(silver_algo_hash_flow_summary(), assert_expected())
